...
//@ constructors
AstarPlannerROS ();
AstarPlannerROS (ros::NodeHandle &nh);
...
vector<int> constructPath(int startCell, int goalCell, int Parent[]);
...
void addNeighborCellToOpenList(std::vector<int>& openList, int neighborCell, int goalCell, float g_score[],float f_cost[]);
